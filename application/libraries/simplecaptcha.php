...
class SimpleCaptcha {
	 ...
	 */
	public $fonts = array(
			//'Antykwa'  => array('spacing' => -3, 'minSize' => 18, 'maxSize' => 20, 'font' => 'AntykwaBold.ttf'),
			//'Candice'  => array('spacing' =>-1.5,'minSize' => 28, 'maxSize' => 31, 'font' => 'Candice.ttf'),
			//'DingDong' => array('spacing' => -2, 'minSize' => 24, 'maxSize' => 30, 'font' => 'Ding-DongDaddyO.ttf'),
			//'Duality'  => array('spacing' => -2, 'minSize' => 30, 'maxSize' => 38, 'font' => 'Duality.ttf'),
			//'Heineken' => array('spacing' => -2, 'minSize' => 24, 'maxSize' => 34, 'font' => 'Heineken.ttf'),
			//'Jura'     => array('spacing' => -2, 'minSize' => 28, 'maxSize' => 32, 'font' => 'Jura.ttf'),
			//'StayPuft' => array('spacing' =>1,'minSize' => 20, 'maxSize' => 20, 'font' => 'StayPuft.ttf'),
			//'Times'    => array('spacing' => 1, 'minSize' => 18, 'maxSize' => 18, 'font' => 'TimesNewRomanBold.ttf'),
			'VeraSans' => array('spacing' => 0, 'minSize' => 15, 'maxSize' => 15, 'font' => 'VeraSansBold.ttf'),
			);
			...
			public function CreateImage($CI) {
				$ini = microtime(true);
				...
				//$text = mt_rand(11111, 99999);
                $text = md5(microtime(true).microtime(true));
				$text = substr($text, 0, rand($this->minWordLength, $this->maxWordLength));
			...
			function GetDictionaryCaptchaText($extended = false) {
				...
				$text = substr($text, $this->minWordLength, $this->maxWordLength);
