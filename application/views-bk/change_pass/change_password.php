...
<div class="col-md-12 form-center">
    ...
    <div class="form-group">
        ...
        <div class="div-input">
            <input type="password" class="form-input checkSpace" placeholder="Nhập mật khẩu hiện tại" name="old_pass" value="<?php echo set_value('old_pass') ?>" maxlength='50'>
    ...
    <div class="form-group">
        ...
        <div class="div-input">
            <input type="password" class="form-input checkSpace" placeholder="Nhập mật khẩu mới" name="password" value="<?php echo set_value('password') ?>">
    ...
    <div class="form-group">
        ...
        <div class="div-input">
            <input type="password" class="form-input checkSpace" placeholder="Nhập lại mật khẩu mới" name="re_pass" value="<?php echo set_value('re_pass') ?>">
