...
<?php if($this->session_memcached->userdata['info_user']['email'] == ""): ?>
	<div class="txt_account">Chưa có thông tin Email. Vui lòng nhập thông tin bên dưới</div>
<?php else: ?>
...
<div class="col-md-12 form-center">
        ...
        <?php if(isset($sentOtp)): ?>
            <?php if(isset($messSentOtp)): ?>
                <div class="form-group">
                    <label><?php echo $messSentOtp ?> Không nhận OTP <a>Click gửi lại</a></label>
    ...
    <?php else: ?>
        ...
        <div class="form-group">
            ...
            <div class="div-input">
                <input name="newemail" class="form-input checkSpace" type="text" placeholder="Nhập email mới">
        ...
        <div class="form-group">
            ...
            <div class="div-input">
                <input name="password" class="form-input checkSpace" type="password">
