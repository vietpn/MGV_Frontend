		...
		<?php endif; ?>
			...
			<div class="form-group">
				...
				<div class="div-input col-md-3 col-lg-3 col-xs-12 col-sm-12">
					<input type="password" class="form-input checkSpace" name="old_pass" value="<?php echo set_value('old_pass') ?>" maxlength='50'>
					<?php if(!isset($is_reset)): ?>
			...
			<div class="form-group ">
				...
				<div class="div-input col-md-3 col-lg-3 col-xs-12 col-sm-12">
					<input type="password" class="form-input checkSpace" name="password" value="<?php echo set_value('password') ?>">
			...
			<div class="form-group">
				...
				<div class="div-input col-md-3 col-lg-3 col-xs-12 col-sm-12">
					<input type="password" class="form-input checkSpace" name="re_pass" value="<?php echo set_value('re_pass') ?>">
