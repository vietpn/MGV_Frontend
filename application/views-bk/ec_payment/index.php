...
<div class="col-md-12 form-center">
	...
	<?php if($userInfo['security_method'] == '1'): ?>
		<?php if (isset($SendOTP)): ?>
			...
			<div class="form-group">
				...
				<div class="div-input">
					<input name="otp" class="form-input" type="password" value="<?php echo set_value('otp'); ?>" placeholder="Nhập OTP">
	...
	<?php if (isset($passLv2)): ?>
        ...
        <div class="form-group">
            ...
            <div class="div-input">
                <input name="passLv2" class="form-input" type="password" value="<?php echo set_value('passLv2'); ?>" placeholder="Nhập mật khẩu cấp 2">
