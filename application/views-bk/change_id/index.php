...
<?php echo form_open_multipart('change_id', array('method' => 'post', 'role' => 'form')); ?>
	...
	<div class="form-group">
        ...
        <div class="div-input">
            <input class="form-input" type="text"
                   value="<?php if($this->session_memcached->userdata['info_user']['fullname'] != '') echo $this->session_memcached->userdata['info_user']['fullname']; ?>"
	...
	<div class="form-group">
		...
		<div class="div-input">
			<input class="form-input" type="text"
				value="<?php if($this->session_memcached->userdata['info_user']['idNo'] != '') echo $this->session_memcached->userdata['info_user']['idNo']; ?>" 
	...
	<div class="form-group">
		...
		<div class="div-input">
			<input class="form-input cmnd-timepicker" type="text"
				value="<?php if($this->session_memcached->userdata['info_user']['birthday'] != '') echo date('d-m-Y', strtotime($this->session_memcached->userdata['info_user']['birthday'])); ?>" 
	...
	<div class="form-group">
		...
		<div class="div-input">
			<input class="form-input cmnd-timepicker" type="text"
				value="<?php if($this->session_memcached->userdata['info_user']['idNo_dateIssue'] != '') echo date('d-m-Y', strtotime($this->session_memcached->userdata['info_user']['idNo_dateIssue'])); ?>" 
            ...
            <div class="link">
                <?php if($this->session_memcached->userdata['info_user']['validate_idno'] == '0' || $this->session_memcached->userdata['info_user']['validate_idno'] == '3'): ?>
                    <a id="openUploadDialogFront" href="javascript:void(0)" style="float: left;">Chọn ảnh 1
                        <img id="imagesFrontSide" class="images_id" style="cursor: pointer; <?php if(empty($this->session_memcached->userdata['info_user']['id_img_f'])) echo 'display:none' ; ?>"
                ...
                <?php if($this->session_memcached->userdata['info_user']['validate_idno'] == '0' || $this->session_memcached->userdata['info_user']['validate_idno'] == '3'): ?>
                    <a id="openUploadDialogBack" href="javascript:void(0)"  style="float: left; margin-left: 20px;">Chọn ảnh 2
                        <img id="imagesBackSide" class="images_id" style="cursor: pointer; <?php if(empty($this->session_memcached->userdata['info_user']['id_img_b'])) echo 'display:none'; ?> "
