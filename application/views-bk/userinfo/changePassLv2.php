...
<div class="col-md-12 form-center">
    ...
    <div class="form-group">
        ...
        <div class="div-input">
            <input name="passLv2" class="form-input checkSpace" type="password" placeholder="Nhập mật khẩu cấp 2 hiện tại">
    ...
    <div class="form-group">
        ...
        <div class="div-input">
            <input name="newpassLv2" class="form-input checkSpace" type="password" placeholder="Nhập mật khẩu cấp 2 mới">
    ...
    <div class="form-group">
        ...
        <div class="div-input">
            <input name="repassLv2" class="form-input checkSpace" type="password" placeholder="Nhập lại mật khẩu cấp 2 mới">
