								...
								<?php echo form_open('transaction_manage/verify_phone', array('method' => 'post', 'role' => 'form')); ?>
									...
									<div class="form-group">
										...
										<div class="input-security">
											...
											<?php echo (isset($error['otp'])) ? $error['otp'] : '' ?>
										</div>
										<div class="clearfix"></div>
									</div>
									<input type="hidden" name="updatePhone" value="Xác nhận"/>
									<div class="col-md-8 col-lg-8 col-xs-8 col-sm-8 col-lg-offset-3 form-group">
										<input type="submit" class="col-md-5 col-lg-5 col-xs-5 col-sm-5 btn btn-accept" name="updatePhone" value="Xác nhận"/>
									</div>
								<?php  echo form_close(); ?>
							</div>
						<?php endif; ?>
