	...
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-security">
			...
			<?php if($user_info['mobileNo'] == ''): ?>
				...
				<?php echo form_close(); ?>
			<?php else: ?>
				<div class="security_info" style="margin-left: 18px; float: left;">
					...
					<div id="btn-sendotp" class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="<?php echo (isset($sendOtp)) ? 'display: none' : '' ; ?>">
						...
						<a id='sendOtpVerifyMobile' class="col-lg-offset-3 col-md-5 col-lg-5 col-xs-6 col-sm-6 btn btn-accept" />Gửi OTP</a>
					</div>
					...
					<?php echo form_open('transaction_manage/verify_phone', array('method' => 'post', 'role' => 'form')); ?>
							...
							<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								<div class="form-group ">
									<label style="text-align: center;">Nhập OTP</label>
						...
						<div id="btn-sendotp" class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
							<input type="submit" class="col-lg-offset-3 col-md-5 col-lg-5 col-xs-5 col-sm-5 btn btn-accept" value="Xác nhận"/>
						</div>
