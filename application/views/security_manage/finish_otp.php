...
<div class="col-md-12 col-lg-12 form-center">
	<div class="row">
				...
				<div class="change-pass-top-form">
					<ol class="progtrckr phone" data-progtrckr-steps="4">

						<li class="progtrckr-todo step_one"><span>Xác thực thông tin</span></li>
						<li class="progtrckr-todo step_two" style="display: none;"><span class="hidden-xs hidden-sm">Hoàn thành</span></li>
						<li class="progtrckr-done step_three"><span class="hidden-xs hidden-sm">Hoàn thành</span></li>
				...
				<div class="text-center">
					<img src="<?php echo base_url().'images/success.png';?>" alt="" class="img-responsive header" />
				...
				<div class="result-text">
		    		...
		    		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
		        		<a class="btn btn-accept" href="/change_security">QUAY LẠI</a>
				    </div>
					</div>
		        </div>
