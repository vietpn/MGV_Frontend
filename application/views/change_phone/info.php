		...
		<?php if($this->session_memcached->userdata['info_user']['phone_status'] == 1): ?>
			<?php if(isset($sentOtp)): ?>
				<?php if(isset($messSentOtp)): ?>
					<div class="form-group" style="white-space: nowrap;"><?php echo $messSentOtp ?> Không nhận OTP <a id="resendOtp">Click gửi lại</a></div>
				<?php endif; ?>
			<?php endif; ?>
		...
		<?php else: ?>
			<?php echo form_open('/change_phone/changePhone', array('method' => 'post', 'role' => 'form')); ?>
				...
				<div class="form-group ">
					...
					<div class=" div-input">
						<input name="password" class="form-input" type="password" autocomplete="off">
