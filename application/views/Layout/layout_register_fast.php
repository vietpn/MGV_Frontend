    ...
    <div class="row content">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 form-input">
            <div class="input-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                ...
                <input type="password" name="password" class="col-md-12 col-lg-12 col-xs-12 col-sm-12" placeholder="Mật khẩu" autocomplete="off"/>
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 form-input">
            <div type="password" class="input-group col-md-12 col-lg-12 col-xs-12 col-sm-12">
                ...
                <input type="password" name="re_password" class="col-md-12 col-lg-12 col-xs-12 col-sm-12 last_input" placeholder="Nhập lại mật khẩu" autocomplete="off"/>
