            ...
            <div class="tab-main">
                <div class="form-center">
                    ...
                    <div class="form-group">
                        ...
                        <div class="div-input">
                            <input class="form-input change_currency" type="text" name="amount" maxlength="14" placeholder="Nhập số tiền cần nạp">
                    ...
                    <div class="form-group button-group">
                        ...
                        <div class="div-input">
                            <input type="submit" class="btn btn-defaul button button-main" value="Nạp tiền"/>
                            <a class="btn btn-defaul button button-sub">Hủy</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <?php echo form_close(); ?>
