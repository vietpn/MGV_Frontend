		  ...
		  <div class="modal-body modal-body-security" >
			<?php echo form_open('/user_info/update_info', array('method' => 'post', 'role' => 'form', 'id' => 'update_info')); ?>
			 ...
			 <?php if($this->session_memcached->userdata['info_user']['security_method'] == '1'): ?>
				<span style="display: block; text-align: center; margin-bottom: 20px;">Nhập OTP để hoàn tất thủ tục thay đổi thông tin cá nhân</span>
				<div class="group-security">
					<div class="security_info" style="float: left">
						
						<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
							<div class="form-group">
								<label style="width: 175px; text-align: right; padding-right: 15px;">OTP</label>
								<div class="input-security">
									<input name="otp" type="password" value="" autocomplete="off">
			 ...
			 <?php else: ?>
				<span style="display: block; text-align: center; margin-bottom: 20px;">Nhập mật khẩu cấp 2 để hoàn tất thủ tục thay đổi thông tin cá nhân</span>
				<div class="group-security">
					<div class="security_info" style="float: left">
					
						<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
							<div class="form-group">
								<label style="width: 175px; text-align: right; padding-right: 15px;">Mật khẩu cấp 2</label>
								<div class="input-security">
