							...
							<div class="security_info">
								<div class="txt_security" >
									...
									<div class="input-security">
										<input name="otp" type="password" class="checkSpace" autocomplete="off">
						...
						<div class="security_info" style="margin-left: 18px; float: left; <?php echo (isset($checkBox) && $checkBox == '2') ? 'display:block' : 'display:none'; ?>">
							<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								<div class="form-group">
									...
									<div class="input-security">
										<input name="passLv2" type="password" class="checkSpace" autocomplete="off">
							...
							<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								<div class="form-group">
									...
									<div class="input-security">
										<input name="rePasLv2" type="password" class="checkSpace" autocomplete="off">
