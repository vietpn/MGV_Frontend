	...
	<div class="col-md-12 form-center">
			...
			<?php echo form_open('/buy_card/buy_list_card', array('method' => 'post', 'role' => 'form')); ?>
			...
			<div class="form-group">
                 ...
                 <div class="div-input">
                     <span style="line-height: 40px;"><?php echo number_format($post['quantity']); ?></span>
                 </div>
                 <div class="clearfix"></div>
             </div>
			...
			<div class="form-group">
                ...
                <div class="div-input">
                    <span id="totalAmount" class="amount" style="line-height: 40px;"><?php echo isset($totalAmount) ? number_format($totalAmount) : 0 ?></span>
                </div>
                <div class="clearfix"></div>
            </div>
			...
			<div class="form-group button-group">
				...
				<div class="div-input">
					...
					<a href="/buy_card" class="button button-sub"/>Hủy</a>
				</div>
				<div class="clearfix"></div>
			</div>
		</form>
