<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-center">
	...
	<?php echo form_open('reset_password/confirm_reset',array('method'=>'post','class'=>'col-xs-12 col-sm-12','role'=>'form')); ?>
		...
		<div class="form-group" style="width: 625px;">
			...
			<div class="">
				<input style="width: 330px; margin: 0px auto;" type="password" class="form-input checkSpace" name="otp" value="<?php echo set_value('otp') ?>" placeholder="Nhập mã OTP" autocomplete="off">
				<span class="form-error" style="margin: 0px auto; width: 330px;"><?php echo form_error('otp'); ?></span>
			</div>
			<div class="clearfix"></div>
		</div>
	...
	<?php echo form_open('reset_password',array('method'=>'post','class'=>'col-xs-12 col-sm-12','role'=>'form')); ?>
		...
		<div class="form-group" style="width: 625px;">
			...
			<div class="">
				...
				<span class="form-error" style="margin: 0px auto; width: 330px;"><?php echo form_error('uname'); ?></span>
			</div>
			<div class="clearfix"></div>
		</div>
	...
	<?php echo form_open('reset_password',array('method'=>'post','class'=>'col-xs-12 col-sm-12','role'=>'form')); ?>
		...
		<div class="form-group" style="width: 625px;">
			...
			<div class="">
				...
				<span class="form-error" style="margin: 0px auto; width: 330px;"><?php if(isset($form_error)) echo $form_error; ?><?php echo form_error('p_request'); ?></span>
			</div>
			<div class="clearfix"></div>
