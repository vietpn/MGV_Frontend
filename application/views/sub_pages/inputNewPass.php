	...
	<div class="col-md-12 col-sm-12 col-xs-12 form-center">
			...
			<?php echo form_open('reset_password/change_pass',array('method'=>'post','class'=>'col-xs-12 col-sm-12','role'=>'form')); ?>
				...
				<div class="form-group">
					...
					<div class="div-input">
						<input type="password" class="form-input" name="passwd" value="<?php echo set_value('passwd') ?>" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="div-input">
						<input type="password" class="form-input" name="rpasswd" value="<?php echo set_value('rpasswd') ?>" autocomplete="off">
