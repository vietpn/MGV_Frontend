...
<div class="col-md-12 form-center">
			...
			<?php echo form_open("/banks_account/updateBankAccount/" . $bankInfo->rowId . '/' . $bankInfo->bankAccount . '/' . $bankInfo->bankCode, array('method' => 'post', 'role' => 'form')); ?>
			<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
			<input name="bank_code" type="hidden" value="<?php echo $bankInfo->bankCode; ?>" />
			<input name="row_id" type="hidden" value="<?php echo $bankInfo->rowId; ?>" />
			<div class="form-group">
				<label>Ngân hàng</label>
				<div class="div-input">
					<input name="bank_name" class="form-input" type="text" value="<?php echo $bankInfo->bankName; ?>" readonly>
				</div>
			...
			<div class="form-group">
				...
				<div class="div-input">
					<input name="bank_account_name" class="form-input" type="text" value="<?php echo $bankInfo->bankAccountName; ?>">
			...
			<div class="form-group">
				...
				<div class="div-input">
					<input name="bank_account" class="form-input" type="text" value="<?php echo $bankInfo->bankAccount; ?>">
					...
					<select name="province_code" class="form-input">
						<?php if(isset($listProvince)): ?>
							<?php foreach($listProvince as $province): ?>
								...
								<option value="<?php echo $province->provinceId; ?>" <?php if($bankInfo->province == $province->provinceId) echo "selected" ?>>
			...
			<div class="form-group">
				...
				<div class="div-input">
					<input name="bank_branch" class="form-input" type="text" value="<?php echo $bankInfo->bankBranch; ?>">
