    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="form-group" style="padding-left:70px;">
                <a class="button button-main button180" href="<?php echo base_url('payment_game'); ?>" style="color:#333;">Về trang nạp tiền game</a>
                <a id="re-trans-history" href="<?php echo base_url() . 'trans_history/index/paymentgame/' . $detail['trans_id']; ?>" class="button button-sub button180">Xem lịch sử giao dịch</a>
            </div>
        </div>
    </div>
</div>
