	...
	<div class="header-page">
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					HotLine: 190010000
					<?php if(isset($user_info['info_user']['userID'])): ?>
					<a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Menu</a>
					<?php endif; ?>
				</div>
				<div class="menu-nav">
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<?php if (!isset($user_info['info_user'])) { ?>
...
if(isset($user_info['info_user']['userID'])):
	if($user_info['info_user']['security_method'] == "0" && $user_info['info_user']['email_status'] == '0'):
 ?>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body" style="min-height: 500px;">
			 <!--iframe style="min-height: 450px;" src="/security_manage" width="100%" frameborder="0" scrolling="no"></iframe--> 
			 <?php 
